...
var JSHINT = (function() {
  ...
  function quit(code, line, chr) {
    ...
    throw {
      ...
      line: line,
      character: chr,
      message: message + " (" + percentage + "% escaneado).",
      raw: message,
      code: code
    };
  }
...
var errors = {
  E001: "Opção ruim: '{a}'.",
  E002: "Opção de valor ruim.",
  E003: "Espera um valor em JSON.",
  E004: "A entrada não é uma string nem um array de strings.",
  E005: "A entrada está vazia.",
  E006: "Fim antecipado inesperado do programa",
  E007: "Instrução \"use strict\" em falta.",
  E008: "Violação rigorosa.",
  E009: "A opção 'validthis' não pode ser usada em um escopo global.",
  E010: "'with' não é permitido no modo rigoroso.",
  E011: "'{a}' já foi declarado.",
  E012: "Constante '{a}' é inicializada como 'undefined'.",
  E013: "Tentando anular '{a}' que é uma constante.",
  E014: "Um literal de expressão regular pode ser confundido com '/='.",
  E015: "Expressão regular não fechada.",
  E016: "expressão regular invalida.",
  E017: "Comentario não foi fechado.",
  E018: "Comentario não foi iniciado.",
  E019: "Não pode comparar '{a}'.",
  E020: "Esperado '{a}' para comparar '{b}' da linha {c} e ao invez disto viu '{d}'.",
  E021: "Esperado '{a}' e ao invez disso viu '{b}'.",
  E022: "Erro na quebra de linha '{a}'.",
  E023: "Perdido '{a}'.",
  E024: "Não esperado '{a}'.",
  E025: "Perdido ':' em uma cláusula de caso.",
  E026: "Perdido '}' para comparar '{' da linha {a}.",
  E027: "Perdido ']' para comparar '[' da linha {a}.",
  E028: "Virgula ilegal.",
  E029: "String não fechada.",
  E030: "Esperado um identificador e, em vez disso, viu '{a}'.",
  E031: "Má atribuição.", // FIXME: Rephrase
  E032: "Esperado um inteiro pequeno ou 'falso' e, em vez disso, viu '{a}'.",
  E033: "Esperava um operador e, em vez disso, viu '{a}'.",
  E034: "get / set são recursos do ES5.",
  E035: "Nome da propriedade ausente.",
  E036: "Espera-se ver uma declaração e, em vez disso, viu um bloco.",
  E037: null,
  E038: null,
  E039: "Declarações de função não são invocáveis. Envolva toda a invocação da função nos pais.",
  E040: "Cada valor deve ter seu próprio rótulo de caso.",
  E041: "Erro de sintaxe irrecuperável.",
  E042: "Parando.",
  E043: "Muitos erros.",
  E044: null,
  E045: "Inválido para cada loop.",
  E046: "Uma declaração de rendimento deve estar dentro de uma função geradora (com sintaxe: `function*`)",
  E047: null,
  E048: "{a} declaração não diretamente dentro do bloco.",
  E049: "Um {a} não pode ser nomeado para '{b}'.",
  E050: "Mozilla requer que a expressão de rendimento seja entre parênteses aqui.",
  E051: null,
  E052: "Literal de modelo não fechado.",
  E053: "Declaração de exportação deve estar no escopo global.",
  E054: "Propriedades de classe devem ser métodos. Esperado '(' mas em vez disso viu '{a}'.",
  E055: "A opção '{a}' não pode ser definida após qualquer código executável.",
  E056: "'{a}' foi usado antes de ser declarado, o que é ilegal para variáveis '{b}'.",
  E057: "Propriedade meta inválida: '{a}.{b}'.",
  E058: "Faltando ponto-e-vírgula.",
};

var warnings = {
  W001: "'hasOwnProperty' é um nome muito ruim.",
  W002: "Valor de '{a}' pode ser sobrescrito no IE 8 e anterior.",
  W003: "'{a}' foi usado antes de ser definido.",
  W004: "'{a}' já está definido.",
  W005: "Um ponto após um número pode ser confundido com um ponto decimal.",
  W006: "Minuses confusos.",
  W007: "Plusses confusos.",
  W008: "Um ponto decimal principal pode ser confundido com um ponto: '{a}'.",
  W009: "A notação literal da array [] é preferível.",
  W010: "A notação literal do objeto {} é preferível.",
  W011: null,
  W012: null,
  W013: null,
  W014: "Linha ruim quebra antes '{a}'.",
  W015: null,
  W016: "Uso inesperado de '{a}'.",
  W017: "operação ruim.",
  W018: "Uso confuso de '{a}'.",
  W019: "use a função isNaN para comparar com NaN.",
  W020: "Somente leitura.",
  W021: "Reatribuição de '{a}', que é um {b}. "+
     "Use 'var' ou 'let' para declarar ligações que podem mudar.",
  W022: "Não atribuir ao parâmetro de exceção.",
  W023: "Esperado um identificador em uma atribuição e, em vez disso, viu uma chamada de função.",
  W024: "Esperado um identificador e, em vez disso, viu '{a}' (uma palavra reservada).",
  W025: "Nome ausente na declaração de função.",
  W026: "Funções internas devem ser listadas no topo da função externa.",
  W027: "Inacessível '{a}' depois '{b}'.",
  W028: "Rótulo '{a}' na declaração {b}.",
  W030: "Esperava uma atribuição ou chamada de função e, em vez disso, viu uma expressão.",
  W031: "Não use 'novo' para efeitos colaterais.",
  W032: "Ponto e vírgula desnecessário.",
  W033: "Ponto e vírgula Perdido.",
  W034: "Diretiva desnecessária \"{a}\".",
  W035: "Bloco vazio.",
  W036: "Inesperado /*membro '{a}'.",
  W037: "'{a}' é um rótulo de declaração.",
  W038: "'{a}' usado fora do escopo.",
  W039: "'{a}' não é permitido.",
  W040: "Pviolação estrita possível.",
  W041: "Use '{a}' para comparar com '{b}'.",
  W042: "Evite escapar do EOL.",
  W043: "Fuga ruim do EOL. Use a opção multistr se necessário.",
  W044: "Ruim ou fuga desnecessária",
  W045: "Número inválido '{a}'.",
  W046: "Não use zeros extras à esquerda '{a}'.",
  W047: "Um ponto decimal à direita pode ser confundido com um ponto: '{a}'.",
  W048: "Caractere de controle inesperado na expressão regular",
  W049: "Caractere inesperado escapado '{a}' na expressão regular.",
  W050: "URL JavaScript",
  W051: "As variáveis não devem ser excluídas",
  W052: "Inesperado '{a}'.",
  W053: "Não use {a} como um construtor",
  W054: "O construtor Function é uma forma de eval.",
  W055: "Um nome de construtor deve começar com uma letra maiúscula",
  W056: "Construtor ruim",
  W057: "Construção estranha. É necessário 'new' ?",
  W058: "Missing '()' invocando um construtor",
  W059: "Evite argumentos. {A}.",
  W060: "document.write pode ser uma forma de eval.",
  W061: "eval pode ser prejudicial",
  W062: "Envolva uma invocação de função imediata nos pais" +
    "para ajudar o leitor a entender que a expressão" +
    "é o resultado de uma função, e não a função em si.",
  W063: "Math não é uma função",
  W064: "Falta o 'new' prefixo ao invocar um construtor.",
  W065: "Parâmetro radix ausente",
  W066: "eval implicado. Considere a passagem de uma função em vez de uma string.",
  W067: "Invocação incorreta",
  W068: "Envolver literais de função non-IIFE em parênteses é desnecessário.",
  W069: "['{a}'] é melhor escrito em notação de ponto.",
  W070: "Extra vírgula. (Quebra versões mais antigas do IE)",
  W071: "Esta função tem instruções demais. ({a})",
  W072: "Esta função tem muitos parâmetros. ({a})",
  W073: "Os blocos estão aninhados muito profundamente. ({a})",
  W074: "A complexidade ciclomática dessa função é muito alta. ({a})",
  W075: "Duplicar {a} '{b}'.",
  W076: "Parâmetro inesperado '{a}' na função get {b}.",
  W077: "Espera-se um único parâmetro na função set {a}",
  W078: "Setter é definido sem getter",
  W079: "Redefinição de '{a}'.",
  W080: "Não é necessário inicializar '{a}' para 'indefinido'",
  W081: null,
  W082: "Declarações de função não devem ser colocadas em blocos." +
     "Use uma expressão de função ou mova a instrução para o topo de" +
     "a função externa",
  W083: "Não faça funções dentro de um loop",
   W084: "Atribuição em expressão condicional",
   W085: "Não use 'with'.",
   W086: "Espera-se uma instrução 'break' antes de '{a}'.",
   W087: "Declaração do 'debugger esquecido'",
   W088: "Criando global 'para' variável. Deve ser 'for (var {a} ...'.",
   W089: "O corpo de um for deve ser empacotado em uma declaração if para filtrar" +
     "propriedades indesejadas do protótipo",
   W090: "'{a}' não é um rótulo de declaração",
  W091: null,
  W093: "Você quis dizer retornar uma condicional em vez de uma atribuição?",
  W094: "vírgula inesperada",
  W095: "Esperava uma string e, em vez disso, viu {a}",
  W096: "A tecla '{a}' pode produzir resultados inesperados.",
 W097: "Use o formulário de função de \"use strict\".",
  W098: "'{a}' é definido mas nunca usado.",
  W099: null,
  W100: "Esse caractere pode ser excluído silenciosamente por um ou mais navegadores",
  W101: "A linha é muito longa",
  W102: null,
  W103: "A propriedade '{a}' está obsoleta.",
  W104: "'{a}' está disponível em ES {b} (use 'esversion: {b}') ou em extensões JS Mozilla (use moz).",
  W105: "Inesperado {a} em '{b}'.",
  W106: "Identificador '{a}' não está no caso camelo",
  W107: "URL do script",
  W108: "Strings devem usar doublequote.",
  W109: "Strings devem usar singlequote.",
  W110: "Aspas duplas e simples mistas",
  W112: "string não fechada",
  W113: "Controlar caractere em string: {a}.",
  W114: "Evite {a}",
  W115: "literais octal não são permitidos no modo estrito.",
  W116: "Esperado '{a}' e em vez disso viu '{b}'.",
  W117: "'{a}' não está definido.",
  W118: "'{a}' está disponível apenas nas extensões JavaScript do Mozilla (use a opção moz).",
  W119: "'{a}' só está disponível em ES {b} (use 'esversion: {b}').",
  W120: "Você pode estar vazando uma variável ({a}) aqui.",
  W121: "Estendendo o protótipo do objeto nativo: '{a}'.",
  W122: "Valor de tipo inválido '{a}'",
  W123: "'{a}' já está definido no escopo externo.",
  W124: "Uma função geradora deve conter uma declaração de rendimento.",
  W125: "Esta linha contém espaços não separáveis: http://jshint.com/doc/options/#nonbsp",
  W126: "Operador de agrupamento desnecessário",
  W127: "Uso inesperado de um operador de vírgula.",
  W128: "Elementos de matriz vazios requerem elision = true.",
  W129: "'{a}' é definido em uma versão futura do JavaScript. Use um" +
    "nome de variável diferente para evitar problemas de migração",
  W130: "Elemento inválido após o elemento de descanso",
  W131: "Parâmetro inválido após o parâmetro de descanso",
  W132: "declarações `var' são proibidas. Use `let` ou `const` em seu lugar. ",
  W133: "Inválido para- {a} loop no lado esquerdo: {b}.",
  W134: "A opção '{a}' só está disponível quando o código ECMAScript {b} é solto.",
  W135: "{a} pode não ser suportado por ambientes que não sejam de navegador",
  W136: "'{a}' deve estar no escopo da função.",
  W137: "Destruição vazia",
  W138: "Parâmetros regulares não devem vir após parâmetros padrão",
};

var info = {
  I001: "Os avisos de vírgula podem ser desativados com 'laxcomma'.",
  I002: null,
  I003: "A opção ES5 está agora definida por padrão",
};
...
(function() {
    ...
    this.onUpdate = function() {
        ...
        for (var i = 0; i < results.length; i++) {
            ...
            if (raw == "Ponto e vírgula Perdido.") {
